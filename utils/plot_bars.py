...
sets = ['Word', 'Char']
word_pos_accs = [37.93, 81.69, 78.20]
char_pos_accs = [75.51, 93.95, 92.48]
word_morph_accs = [17.21, 69.36, 65.20]
char_morph_accs = [49.89, 82.24, 79.66]
...
def plot_bars_two_sets(accs1, accs2, sets, labels, title, fignum, filename):
...
#plot_bars_two_sets(word_pos_accs, char_pos_accs, sets, labels, 'POS Accuracy by Representation Type', 1, 'pos-acc-repr-type.png')
#plot_bars_two_sets(word_morph_accs, char_morph_accs, sets, labels, 'Morphology Accuracy by Representation Type', 2, 'morph-acc-repr-type.png')
...
def plot_bars_three_sets(accs1, accs2, accs3, sets, labels, title, fignum, filename, indices=None, legend_loc=None):
